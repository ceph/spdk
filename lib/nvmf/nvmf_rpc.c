...
static const struct spdk_json_object_decoder nvmf_rpc_subsystem_ana_group_decoder[] = {
	...
	{"transit_anagrpid", offsetof(struct nvmf_rpc_ana_group_ctx, transit_anagrpid), spdk_json_decode_uint32, true},
				    ...
				    const struct spdk_json_val *params)
{
	...
	if (spdk_json_decode_object_relaxed(params, nvmf_rpc_subsystem_ana_group_decoder,
